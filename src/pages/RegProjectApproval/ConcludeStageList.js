...
class ConcludeStageList extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      selectedRows: [],
  ...
  render() {
    ...
    const cardTitle = type==='1'?'非高校结项阶段':'高校结项阶段';
    const btnList = {
      primaryBtn: [{
...
export default ConcludeStageList;
