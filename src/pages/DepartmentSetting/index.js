...
import { DEPARTMENT_DETAIL_STATUS, DEPARTMENT_TYPE, DEPARTMENT_TYPE_ARRAY} from '../../utils/Enum';
...
class DepartmentSetting extends PureComponent{
  ...
  componentDidMount(){
    ...
    dispatch({
      ...
      payload:{
        department_type:DEPARTMENT_TYPE.ADMIN
      }
    });
    dispatch({
  ...
  handleSelectRows = (selectedRowKeys, selectedRow)=> {
    ...
    // }else{
    //   this.setState({
    //     selectedRows : selectedRow?selectedRow:selectedRowKeys,
